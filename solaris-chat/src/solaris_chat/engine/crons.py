...
DOCUMENT_EXTRACTOR_PROMPT = (
    ...
    "Für JEDE Kandidaten-Companion unten (eine Upload-Notiz mit einem Abschnitt\n"
    "'## Inhalt (extrahiert)'):\n"
    "1. Lies sie mit notes_read — der Abschnitt enthält den Dokumenttext.\n"
    "2. Rufe das Tool document_extract EINMAL auf mit:\n"
    "   - source_document: der exakte Pfad der Companion (wie unten gelistet)\n"
    "   - category: eine von insurance, contract, employment, pension,\n"
    "     health_insurance, bank, tax, vehicle, property, warranty, membership,\n"
    "     id_document, legal, family, appliance, other\n"
    "   - title: kurzer sprechender Titel (z.B. 'ERGO Rechtsschutz')\n"
    "   - dazu die Fach-Felder, die WIRKLICH im Text stehen (provider,\n"
    "     policy_number, cancellation_deadline, …). Datumsangaben als YYYY-MM-DD\n"
    "     ('15.12.2026' → '2026-12-15'). Nichts erfinden, unklare Fristen weglassen.\n"
    "Das Tool schreibt die Dokumentnotiz und markiert die Companion als erledigt —\n"
    "du musst NICHT selbst schreiben. Genau EIN document_extract-Aufruf pro\n"
    "Companion. Antworte nur mit einer kurzen Zusammenfassung.\n"
    "Kandidaten dieser Nacht:\n"
)
