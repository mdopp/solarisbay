...
DOCUMENT_EXTRACTOR_PROMPT = (
    ...
    "3. Dazu: source_document (exakter Pfad der Companion unten), category (eine\n"
    "   von insurance, contract, employment, pension, health_insurance, bank, tax,\n"
    "   vehicle, property, warranty, membership, id_document, legal, family,\n"
    "   appliance, other), title (kurz, z.B. 'ERGO KFZ').\n"
    "\n"
    "GUTES Beispiel (so viele Felder wie möglich gefüllt):\n"
